            ...
            .enqueue(object : Callback<List<LivreSimplifie>> {
                override fun onResponse(
                    ...
                    if (response.isSuccessful) {
                        ...
                        Toast.makeText(this@CatalogueActivity, "Erreur API: ${response.code()}", Toast.LENGTH_SHORT).show()
                    }
                }

                override fun onFailure(call: Call<List<LivreSimplifie>>, t: Throwable) {
                    Toast.makeText(this@CatalogueActivity, "Échec: ${t.message}", Toast.LENGTH_SHORT).show()
                }
            })
    }
